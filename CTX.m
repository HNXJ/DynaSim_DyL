...
vary = {'A','g_poisson',[g_poisson]; 'A','DC_poisson', [1e7];'A','AC_poisson', [0]; 'A', 'onset_poisson', [100]; 'A', 'offset_poisson', [200];
       'B','g_poisson',[g_poisson]; 'B','DC_poisson', [1e7];'B','AC_poisson', [0]; 'B', 'onset_poisson', [200]; 'B', 'offset_poisson', [300]};
