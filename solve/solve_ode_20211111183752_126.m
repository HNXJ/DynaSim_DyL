...
for k=2:ntime
  ...
  P1_u_k1 =P1_w(n-1,:);
  P1_w_k1 =1;
  P1_v_k1 =((((-p.P1_iNa_gNa.*P1_iNa_m(n-1,:).^3.*P1_iNa_h(n-1,:).*(P1_u(n-1,:)-p.P1_iNa_ENa))))+((((-p.P1_iK_gK.*P1_iK_n(n-1,:).^4.*(P1_u(n-1,:)-p.P1_iK_EK))))))+p.P1_noise*randn(1,p.P1_Npop);
  ...
  P2_u_k1 =P2_w(n-1,:);
  P2_w_k1 =1;
  P2_v_k1 =((((-p.P2_iNa_gNa.*P2_iNa_m(n-1,:).^3.*P2_iNa_h(n-1,:).*(P2_u(n-1,:)-p.P2_iNa_ENa))))+((((-p.P2_iK_gK.*P2_iK_n(n-1,:).^4.*(P2_u(n-1,:)-p.P2_iK_EK))))+((((-p.P2_P1_iGABAa_gGABAa.*(P2_P1_iGABAa_s(n-1,:)*P2_P1_iGABAa_netcon).*(P2_u(n-1,:)-p.P2_P1_iGABAa_EGABAa))))+((((-p.P2_P3_iGABAa_gGABAa.*(P2_P3_iGABAa_s(n-1,:)*P2_P3_iGABAa_netcon).*(P2_u(n-1,:)-p.P2_P3_iGABAa_EGABAa))))))))+p.P2_noise*randn(1,p.P2_Npop);
  ...
  P3_u_k1 =P3_w(n-1,:);
  P3_w_k1 =1;
  P3_v_k1 =((((-p.P3_iNa_gNa.*P3_iNa_m(n-1,:).^3.*P3_iNa_h(n-1,:).*(P3_u(n-1,:)-p.P3_iNa_ENa))))+((((-p.P3_iK_gK.*P3_iK_n(n-1,:).^4.*(P3_u(n-1,:)-p.P3_iK_EK))))))+p.P3_noise*randn(1,p.P3_Npop);
  ...
  P1_w_k2 =1;
  P1_v_k2 =((((-p.P1_iNa_gNa.*((P1_iNa_m(n-1,:) + .5*dt*P1_iNa_m_k1)).^3.*((P1_iNa_h(n-1,:) + .5*dt*P1_iNa_h_k1)).*(((P1_u(n-1,:) + .5*dt*P1_u_k1))-p.P1_iNa_ENa))))+((((-p.P1_iK_gK.*((P1_iK_n(n-1,:) + .5*dt*P1_iK_n_k1)).^4.*(((P1_u(n-1,:) + .5*dt*P1_u_k1))-p.P1_iK_EK))))))+p.P1_noise*randn(1,p.P1_Npop);
  ...
  P2_w_k2 =1;
  P2_v_k2 =((((-p.P2_iNa_gNa.*((P2_iNa_m(n-1,:) + .5*dt*P2_iNa_m_k1)).^3.*((P2_iNa_h(n-1,:) + .5*dt*P2_iNa_h_k1)).*(((P2_u(n-1,:) + .5*dt*P2_u_k1))-p.P2_iNa_ENa))))+((((-p.P2_iK_gK.*((P2_iK_n(n-1,:) + .5*dt*P2_iK_n_k1)).^4.*(((P2_u(n-1,:) + .5*dt*P2_u_k1))-p.P2_iK_EK))))+((((-p.P2_P1_iGABAa_gGABAa.*(((P2_P1_iGABAa_s(n-1,:) + .5*dt*P2_P1_iGABAa_s_k1))*P2_P1_iGABAa_netcon).*(((P2_u(n-1,:) + .5*dt*P2_u_k1))-p.P2_P1_iGABAa_EGABAa))))+((((-p.P2_P3_iGABAa_gGABAa.*(((P2_P3_iGABAa_s(n-1,:) + .5*dt*P2_P3_iGABAa_s_k1))*P2_P3_iGABAa_netcon).*(((P2_u(n-1,:) + .5*dt*P2_u_k1))-p.P2_P3_iGABAa_EGABAa))))))))+p.P2_noise*randn(1,p.P2_Npop);
  ...
  P3_w_k2 =1;
  P3_v_k2 =((((-p.P3_iNa_gNa.*((P3_iNa_m(n-1,:) + .5*dt*P3_iNa_m_k1)).^3.*((P3_iNa_h(n-1,:) + .5*dt*P3_iNa_h_k1)).*(((P3_u(n-1,:) + .5*dt*P3_u_k1))-p.P3_iNa_ENa))))+((((-p.P3_iK_gK.*((P3_iK_n(n-1,:) + .5*dt*P3_iK_n_k1)).^4.*(((P3_u(n-1,:) + .5*dt*P3_u_k1))-p.P3_iK_EK))))))+p.P3_noise*randn(1,p.P3_Npop);
  ...
  P1_w_k3 =1;
  P1_v_k3 =((((-p.P1_iNa_gNa.*((P1_iNa_m(n-1,:) + .5*dt*P1_iNa_m_k2)).^3.*((P1_iNa_h(n-1,:) + .5*dt*P1_iNa_h_k2)).*(((P1_u(n-1,:) + .5*dt*P1_u_k2))-p.P1_iNa_ENa))))+((((-p.P1_iK_gK.*((P1_iK_n(n-1,:) + .5*dt*P1_iK_n_k2)).^4.*(((P1_u(n-1,:) + .5*dt*P1_u_k2))-p.P1_iK_EK))))))+p.P1_noise*randn(1,p.P1_Npop);
  ...
  P2_w_k3 =1;
  P2_v_k3 =((((-p.P2_iNa_gNa.*((P2_iNa_m(n-1,:) + .5*dt*P2_iNa_m_k2)).^3.*((P2_iNa_h(n-1,:) + .5*dt*P2_iNa_h_k2)).*(((P2_u(n-1,:) + .5*dt*P2_u_k2))-p.P2_iNa_ENa))))+((((-p.P2_iK_gK.*((P2_iK_n(n-1,:) + .5*dt*P2_iK_n_k2)).^4.*(((P2_u(n-1,:) + .5*dt*P2_u_k2))-p.P2_iK_EK))))+((((-p.P2_P1_iGABAa_gGABAa.*(((P2_P1_iGABAa_s(n-1,:) + .5*dt*P2_P1_iGABAa_s_k2))*P2_P1_iGABAa_netcon).*(((P2_u(n-1,:) + .5*dt*P2_u_k2))-p.P2_P1_iGABAa_EGABAa))))+((((-p.P2_P3_iGABAa_gGABAa.*(((P2_P3_iGABAa_s(n-1,:) + .5*dt*P2_P3_iGABAa_s_k2))*P2_P3_iGABAa_netcon).*(((P2_u(n-1,:) + .5*dt*P2_u_k2))-p.P2_P3_iGABAa_EGABAa))))))))+p.P2_noise*randn(1,p.P2_Npop);
  ...
  P3_w_k3 =1;
  P3_v_k3 =((((-p.P3_iNa_gNa.*((P3_iNa_m(n-1,:) + .5*dt*P3_iNa_m_k2)).^3.*((P3_iNa_h(n-1,:) + .5*dt*P3_iNa_h_k2)).*(((P3_u(n-1,:) + .5*dt*P3_u_k2))-p.P3_iNa_ENa))))+((((-p.P3_iK_gK.*((P3_iK_n(n-1,:) + .5*dt*P3_iK_n_k2)).^4.*(((P3_u(n-1,:) + .5*dt*P3_u_k2))-p.P3_iK_EK))))))+p.P3_noise*randn(1,p.P3_Npop);
  ...
  P1_w_k4 =1;
  P1_v_k4 =((((-p.P1_iNa_gNa.*((P1_iNa_m(n-1,:) + dt*P1_iNa_m_k3)).^3.*((P1_iNa_h(n-1,:) + dt*P1_iNa_h_k3)).*(((P1_u(n-1,:) + dt*P1_u_k3))-p.P1_iNa_ENa))))+((((-p.P1_iK_gK.*((P1_iK_n(n-1,:) + dt*P1_iK_n_k3)).^4.*(((P1_u(n-1,:) + dt*P1_u_k3))-p.P1_iK_EK))))))+p.P1_noise*randn(1,p.P1_Npop);
  ...
  P2_w_k4 =1;
  P2_v_k4 =((((-p.P2_iNa_gNa.*((P2_iNa_m(n-1,:) + dt*P2_iNa_m_k3)).^3.*((P2_iNa_h(n-1,:) + dt*P2_iNa_h_k3)).*(((P2_u(n-1,:) + dt*P2_u_k3))-p.P2_iNa_ENa))))+((((-p.P2_iK_gK.*((P2_iK_n(n-1,:) + dt*P2_iK_n_k3)).^4.*(((P2_u(n-1,:) + dt*P2_u_k3))-p.P2_iK_EK))))+((((-p.P2_P1_iGABAa_gGABAa.*(((P2_P1_iGABAa_s(n-1,:) + dt*P2_P1_iGABAa_s_k3))*P2_P1_iGABAa_netcon).*(((P2_u(n-1,:) + dt*P2_u_k3))-p.P2_P1_iGABAa_EGABAa))))+((((-p.P2_P3_iGABAa_gGABAa.*(((P2_P3_iGABAa_s(n-1,:) + dt*P2_P3_iGABAa_s_k3))*P2_P3_iGABAa_netcon).*(((P2_u(n-1,:) + dt*P2_u_k3))-p.P2_P3_iGABAa_EGABAa))))))))+p.P2_noise*randn(1,p.P2_Npop);
  ...
  P3_w_k4 =1;
  P3_v_k4 =((((-p.P3_iNa_gNa.*((P3_iNa_m(n-1,:) + dt*P3_iNa_m_k3)).^3.*((P3_iNa_h(n-1,:) + dt*P3_iNa_h_k3)).*(((P3_u(n-1,:) + dt*P3_u_k3))-p.P3_iNa_ENa))))+((((-p.P3_iK_gK.*((P3_iK_n(n-1,:) + dt*P3_iK_n_k3)).^4.*(((P3_u(n-1,:) + dt*P3_u_k3))-p.P3_iK_EK))))))+p.P3_noise*randn(1,p.P3_Npop);
