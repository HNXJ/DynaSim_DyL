...
for k=2:ntime
  ...
  L3_v_k2 =p.L3_Iapp+((((-p.L3_iNa_gNa.*((L3_iNa_m(n-1,:) + .5*dt*L3_iNa_m_k1)).^3.*((L3_iNa_h(n-1,:) + .5*dt*L3_iNa_h_k1)).*(((L3_v(n-1,:) + .5*dt*L3_v_k1))-p.L3_iNa_ENa))))+((((-p.L3_iK_gK.*((L3_iK_n(n-1,:) + .5*dt*L3_iK_n_k1)).^4.*(((L3_v(n-1,:) + .5*dt*L3_v_k1))-p.L3_iK_EK))))))+p.L3_noise*randn(1,p.L3_Npop);
  ...
  L3_v_k3 =p.L3_Iapp+((((-p.L3_iNa_gNa.*((L3_iNa_m(n-1,:) + .5*dt*L3_iNa_m_k2)).^3.*((L3_iNa_h(n-1,:) + .5*dt*L3_iNa_h_k2)).*(((L3_v(n-1,:) + .5*dt*L3_v_k2))-p.L3_iNa_ENa))))+((((-p.L3_iK_gK.*((L3_iK_n(n-1,:) + .5*dt*L3_iK_n_k2)).^4.*(((L3_v(n-1,:) + .5*dt*L3_v_k2))-p.L3_iK_EK))))))+p.L3_noise*randn(1,p.L3_Npop);
  ...
  L3_v_k4 =p.L3_Iapp+((((-p.L3_iNa_gNa.*((L3_iNa_m(n-1,:) + dt*L3_iNa_m_k3)).^3.*((L3_iNa_h(n-1,:) + dt*L3_iNa_h_k3)).*(((L3_v(n-1,:) + dt*L3_v_k3))-p.L3_iNa_ENa))))+((((-p.L3_iK_gK.*((L3_iK_n(n-1,:) + dt*L3_iK_n_k3)).^4.*(((L3_v(n-1,:) + dt*L3_v_k3))-p.L3_iK_EK))))))+p.L3_noise*randn(1,p.L3_Npop);
