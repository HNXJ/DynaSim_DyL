function [T,L1_v,L1_iNa_m,L1_iNa_h,L1_iK_n,L2_v,L2_iNa_m,L2_iNa_h,L2_iK_n,L3_v,L3_iNa_m,L3_iNa_h,L3_iK_n,L4_v,L4_iNa_m,L4_iNa_h,L4_iK_n,L5_v,L5_iNa_m,L5_iNa_h,L5_iK_n,L2_L1_iGABAa_s,L2_L5_iAMPA_s,L3_L2_iAMPA_s,L2_L3_iGABA_s,L2_L1_iGABAa_IGABAa,L2_L3_iGABA_IGABA,L2_L5_iAMPA_IAMPA,L3_L2_iAMPA_IAMPA,L2_L1_iGABAa_netcon,L2_L5_iAMPA_netcon,L3_L2_iAMPA_netcon,L2_L3_iGABA_netcon]=solve_ode
...
for k=2:ntime
  ...
  t = t + .5*dt;
  L1_v_k2 =p.L1_Iapp+((((-p.L1_iNa_gNa.*((L1_iNa_m(n-1,:) + .5*dt*L1_iNa_m_k1)).^3.*((L1_iNa_h(n-1,:) + .5*dt*L1_iNa_h_k1)).*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*((L1_iK_n(n-1,:) + .5*dt*L1_iK_n_k1)).^4.*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_iK_EK))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  L1_v_k3 =p.L1_Iapp+((((-p.L1_iNa_gNa.*((L1_iNa_m(n-1,:) + .5*dt*L1_iNa_m_k2)).^3.*((L1_iNa_h(n-1,:) + .5*dt*L1_iNa_h_k2)).*(((L1_v(n-1,:) + .5*dt*L1_v_k2))-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*((L1_iK_n(n-1,:) + .5*dt*L1_iK_n_k2)).^4.*(((L1_v(n-1,:) + .5*dt*L1_v_k2))-p.L1_iK_EK))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  t = t + .5*dt;
  L1_v_k4 =p.L1_Iapp+((((-p.L1_iNa_gNa.*((L1_iNa_m(n-1,:) + dt*L1_iNa_m_k3)).^3.*((L1_iNa_h(n-1,:) + dt*L1_iNa_h_k3)).*(((L1_v(n-1,:) + dt*L1_v_k3))-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*((L1_iK_n(n-1,:) + dt*L1_iK_n_k3)).^4.*(((L1_v(n-1,:) + dt*L1_v_k3))-p.L1_iK_EK))))))+p.L1_noise*randn(1,p.L1_Npop);
