...
for k=2:ntime
  ...
  pop1_v_k1 =-*pop1_u(n-1)-2*p.pop1_l*pop1_v(n-1)+0.01;

  t = t + .5*dt;
  pop1_u_k2 =((pop1_v(n-1) + .5*dt*pop1_v_k1));
  pop1_v_k2 =-*((pop1_u(n-1) + .5*dt*pop1_u_k1))-2*p.pop1_l*((pop1_v(n-1) + .5*dt*pop1_v_k1))+0.01;

  pop1_u_k3 =((pop1_v(n-1) + .5*dt*pop1_v_k2));
  pop1_v_k3 =-*((pop1_u(n-1) + .5*dt*pop1_u_k2))-2*p.pop1_l*((pop1_v(n-1) + .5*dt*pop1_v_k2))+0.01;

  t = t + .5*dt;
  pop1_u_k4 =((pop1_v(n-1) + dt*pop1_v_k3));
  pop1_v_k4 =-*((pop1_u(n-1) + dt*pop1_u_k3))-2*p.pop1_l*((pop1_v(n-1) + dt*pop1_v_k3))+0.01;
