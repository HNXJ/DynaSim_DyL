...
for k=2:ntime
  t=T(k-1);
  L1_v_k1 =p.L1_Iapp+0.9*((((-p.L1_iNa_gNa.*L1_iNa_m(n-1,:).^3.*L1_iNa_h(n-1,:).*(L1_v(n-1,:)-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*L1_iK_n(n-1,:).^4.*(L1_v(n-1,:)-p.L1_iK_EK))))+((-(((p.L1_L4_iGABA_gGABA.*(L1_L4_iGABA_s(n-1,:)*L1_L4_iGABA_netcon).*(L1_v(n-1,:)-p.L1_L4_iGABA_EGABA)))))+((((-p.L1_L3_iAMPA_gAMPA.*(L1_L3_iAMPA_s(n-1,:)*L1_L3_iAMPA_netcon).*(L1_v(n-1,:)-p.L1_L3_iAMPA_EAMPA))))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  L3_v_k1 =p.L3_Iapp+0.9*((((-p.L3_iNa_gNa.*L3_iNa_m(n-1,:).^3.*L3_iNa_h(n-1,:).*(L3_v(n-1,:)-p.L3_iNa_ENa))))+((((-p.L3_iK_gK.*L3_iK_n(n-1,:).^4.*(L3_v(n-1,:)-p.L3_iK_EK))))+((((-p.L3_L2_iAMPA_gAMPA.*(L3_L2_iAMPA_s(n-1,:)*L3_L2_iAMPA_netcon).*(L3_v(n-1,:)-p.L3_L2_iAMPA_EAMPA)))))))+p.L3_noise*randn(1,p.L3_Npop);
  ...
  L4_v_k1 =p.L4_Iapp+0.3*((((-p.L4_iNa_gNa.*L4_iNa_m(n-1,:).^3.*L4_iNa_h(n-1,:).*(L4_v(n-1,:)-p.L4_iNa_ENa))))+((((-p.L4_iK_gK.*L4_iK_n(n-1,:).^4.*(L4_v(n-1,:)-p.L4_iK_EK))))))+p.L4_noise*randn(1,p.L4_Npop);
  ...
  L5_v_k1 =p.L5_Iapp+0.3*((((-p.L5_iNa_gNa.*L5_iNa_m(n-1,:).^3.*L5_iNa_h(n-1,:).*(L5_v(n-1,:)-p.L5_iNa_ENa))))+((((-p.L5_iK_gK.*L5_iK_n(n-1,:).^4.*(L5_v(n-1,:)-p.L5_iK_EK))))))+p.L5_noise*randn(1,p.L5_Npop);
  ...
  t = t + .5*dt;
  L1_v_k2 =p.L1_Iapp+0.9*((((-p.L1_iNa_gNa.*((L1_iNa_m(n-1,:) + .5*dt*L1_iNa_m_k1)).^3.*((L1_iNa_h(n-1,:) + .5*dt*L1_iNa_h_k1)).*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*((L1_iK_n(n-1,:) + .5*dt*L1_iK_n_k1)).^4.*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_iK_EK))))+((-(((p.L1_L4_iGABA_gGABA.*(((L1_L4_iGABA_s(n-1,:) + .5*dt*L1_L4_iGABA_s_k1))*L1_L4_iGABA_netcon).*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_L4_iGABA_EGABA)))))+((((-p.L1_L3_iAMPA_gAMPA.*(((L1_L3_iAMPA_s(n-1,:) + .5*dt*L1_L3_iAMPA_s_k1))*L1_L3_iAMPA_netcon).*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_L3_iAMPA_EAMPA))))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  L4_v_k2 =p.L4_Iapp+0.3*((((-p.L4_iNa_gNa.*((L4_iNa_m(n-1,:) + .5*dt*L4_iNa_m_k1)).^3.*((L4_iNa_h(n-1,:) + .5*dt*L4_iNa_h_k1)).*(((L4_v(n-1,:) + .5*dt*L4_v_k1))-p.L4_iNa_ENa))))+((((-p.L4_iK_gK.*((L4_iK_n(n-1,:) + .5*dt*L4_iK_n_k1)).^4.*(((L4_v(n-1,:) + .5*dt*L4_v_k1))-p.L4_iK_EK))))))+p.L4_noise*randn(1,p.L4_Npop);
  ...
  L5_v_k2 =p.L5_Iapp+0.3*((((-p.L5_iNa_gNa.*((L5_iNa_m(n-1,:) + .5*dt*L5_iNa_m_k1)).^3.*((L5_iNa_h(n-1,:) + .5*dt*L5_iNa_h_k1)).*(((L5_v(n-1,:) + .5*dt*L5_v_k1))-p.L5_iNa_ENa))))+((((-p.L5_iK_gK.*((L5_iK_n(n-1,:) + .5*dt*L5_iK_n_k1)).^4.*(((L5_v(n-1,:) + .5*dt*L5_v_k1))-p.L5_iK_EK))))))+p.L5_noise*randn(1,p.L5_Npop);
  ...
  L4_v_k3 =p.L4_Iapp+0.3*((((-p.L4_iNa_gNa.*((L4_iNa_m(n-1,:) + .5*dt*L4_iNa_m_k2)).^3.*((L4_iNa_h(n-1,:) + .5*dt*L4_iNa_h_k2)).*(((L4_v(n-1,:) + .5*dt*L4_v_k2))-p.L4_iNa_ENa))))+((((-p.L4_iK_gK.*((L4_iK_n(n-1,:) + .5*dt*L4_iK_n_k2)).^4.*(((L4_v(n-1,:) + .5*dt*L4_v_k2))-p.L4_iK_EK))))))+p.L4_noise*randn(1,p.L4_Npop);
  ...
  L5_v_k3 =p.L5_Iapp+0.3*((((-p.L5_iNa_gNa.*((L5_iNa_m(n-1,:) + .5*dt*L5_iNa_m_k2)).^3.*((L5_iNa_h(n-1,:) + .5*dt*L5_iNa_h_k2)).*(((L5_v(n-1,:) + .5*dt*L5_v_k2))-p.L5_iNa_ENa))))+((((-p.L5_iK_gK.*((L5_iK_n(n-1,:) + .5*dt*L5_iK_n_k2)).^4.*(((L5_v(n-1,:) + .5*dt*L5_v_k2))-p.L5_iK_EK))))))+p.L5_noise*randn(1,p.L5_Npop);
  ...
  L4_v_k4 =p.L4_Iapp+0.3*((((-p.L4_iNa_gNa.*((L4_iNa_m(n-1,:) + dt*L4_iNa_m_k3)).^3.*((L4_iNa_h(n-1,:) + dt*L4_iNa_h_k3)).*(((L4_v(n-1,:) + dt*L4_v_k3))-p.L4_iNa_ENa))))+((((-p.L4_iK_gK.*((L4_iK_n(n-1,:) + dt*L4_iK_n_k3)).^4.*(((L4_v(n-1,:) + dt*L4_v_k3))-p.L4_iK_EK))))))+p.L4_noise*randn(1,p.L4_Npop);
  ...
  L5_v_k4 =p.L5_Iapp+0.3*((((-p.L5_iNa_gNa.*((L5_iNa_m(n-1,:) + dt*L5_iNa_m_k3)).^3.*((L5_iNa_h(n-1,:) + dt*L5_iNa_h_k3)).*(((L5_v(n-1,:) + dt*L5_v_k3))-p.L5_iNa_ENa))))+((((-p.L5_iK_gK.*((L5_iK_n(n-1,:) + dt*L5_iK_n_k3)).^4.*(((L5_v(n-1,:) + dt*L5_v_k3))-p.L5_iK_EK))))))+p.L5_noise*randn(1,p.L5_Npop);
