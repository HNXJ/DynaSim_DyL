...
pop1_u = zeros(nsamp,p.pop1_Npop);
  pop1_u(1,:) = 0.01 * ones(1,p.pop1_Npop);
...
for k=2:ntime
  ...
  pop1_w_k1 =1;
  pop1_v_k1 =0+p.pop1_noise*randn(1,p.pop1_Npop);

  t = t + .5*dt;
  pop1_u_k2 =((pop1_w(n-1) + .5*dt*pop1_w_k1));
  pop1_w_k2 =1;
  pop1_v_k2 =0+p.pop1_noise*randn(1,p.pop1_Npop);

  pop1_u_k3 =((pop1_w(n-1) + .5*dt*pop1_w_k2));
  pop1_w_k3 =1;
  pop1_v_k3 =0+p.pop1_noise*randn(1,p.pop1_Npop);

  t = t + .5*dt;
  pop1_u_k4 =((pop1_w(n-1) + dt*pop1_w_k3));
  pop1_w_k4 =1;
  pop1_v_k4 =0+p.pop1_noise*randn(1,p.pop1_Npop);
