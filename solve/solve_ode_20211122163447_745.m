function [T,L1_v,L1_iNa_m,L1_iNa_h,L1_iK_n,L2_v,L2_iNa_m,L2_iNa_h,L2_iK_n,L3_v,L3_iNa_m,L3_iNa_h,L3_iK_n,L4_v,L4_iNa_m,L4_iNa_h,L4_iK_n,L5_v,L5_iNa_m,L5_iNa_h,L5_iK_n,L2_L1_iGABAa_s,L2_L5_iAMPA_s,L3_L2_iAMPA_s,L2_L3_iGABA_s,L1_L4_iGABA_s,L1_L4_iGABA_IGABA,L2_L1_iGABAa_IGABAa,L2_L3_iGABA_IGABA,L2_L5_iAMPA_IAMPA,L3_L2_iAMPA_IAMPA,L2_L1_iGABAa_netcon,L2_L5_iAMPA_netcon,L3_L2_iAMPA_netcon,L2_L3_iGABA_netcon,L1_L4_iGABA_netcon]=solve_ode
...
L2_L3_iGABA_netcon = ones(p.L3_Npop,p.L2_Npop);
...
L2_L3_iGABA_s = zeros(nsamp,p.L3_Npop);
  L2_L3_iGABA_s(1,:) =  p.L2_L3_iGABA_IC+p.L2_L3_iGABA_IC_noise.*rand(1,p.L3_Npop);
...
L2_L3_iGABA_IGABA = zeros(nsamp,p.L2_Npop);
  L2_L3_iGABA_IGABA(1,:)=(p.L2_L3_iGABA_gGABA.*(L2_L3_iGABA_s(1,:)*L2_L3_iGABA_netcon).*(L2_v(1,:)-p.L2_L3_iGABA_EGABA));
...
for k=2:ntime
  t=T(k-1);
  L1_v_k1 =p.L1_Iapp+((((-p.L1_iNa_gNa.*L1_iNa_m(n-1,:).^3.*L1_iNa_h(n-1,:).*(L1_v(n-1,:)-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*L1_iK_n(n-1,:).^4.*(L1_v(n-1,:)-p.L1_iK_EK))))+((-(((p.L1_L4_iGABA_gGABA.*(L1_L4_iGABA_s(n-1,:)*L1_L4_iGABA_netcon).*(L1_v(n-1,:)-p.L1_L4_iGABA_EGABA))))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  L2_L3_iGABA_s_k1 = -L2_L3_iGABA_s(n-1,:)./p.L2_L3_iGABA_tauGABA + ((1-L2_L3_iGABA_s(n-1,:))/p.L2_L3_iGABA_tauGABAr).*(1+tanh(L3_v(n-1,:)/10));
  L1_L4_iGABA_s_k1 = -L1_L4_iGABA_s(n-1,:)./p.L1_L4_iGABA_tauGABA + ((1-L1_L4_iGABA_s(n-1,:))/p.L1_L4_iGABA_tauGABAr).*(1+tanh(L4_v(n-1,:)/10));

  t = t + .5*dt;
  L1_v_k2 =p.L1_Iapp+((((-p.L1_iNa_gNa.*((L1_iNa_m(n-1,:) + .5*dt*L1_iNa_m_k1)).^3.*((L1_iNa_h(n-1,:) + .5*dt*L1_iNa_h_k1)).*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*((L1_iK_n(n-1,:) + .5*dt*L1_iK_n_k1)).^4.*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_iK_EK))))+((-(((p.L1_L4_iGABA_gGABA.*(((L1_L4_iGABA_s(n-1,:) + .5*dt*L1_L4_iGABA_s_k1))*L1_L4_iGABA_netcon).*(((L1_v(n-1,:) + .5*dt*L1_v_k1))-p.L1_L4_iGABA_EGABA))))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  L4_v_k2 =p.L4_Iapp+((((-p.L4_iNa_gNa.*((L4_iNa_m(n-1,:) + .5*dt*L4_iNa_m_k1)).^3.*((L4_iNa_h(n-1,:) + .5*dt*L4_iNa_h_k1)).*(((L4_v(n-1,:) + .5*dt*L4_v_k1))-p.L4_iNa_ENa))))+((((-p.L4_iK_gK.*((L4_iK_n(n-1,:) + .5*dt*L4_iK_n_k1)).^4.*(((L4_v(n-1,:) + .5*dt*L4_v_k1))-p.L4_iK_EK))))))+p.L4_noise*randn(1,p.L4_Npop);
  ...
  L5_v_k2 =p.L5_Iapp+((((-p.L5_iNa_gNa.*((L5_iNa_m(n-1,:) + .5*dt*L5_iNa_m_k1)).^3.*((L5_iNa_h(n-1,:) + .5*dt*L5_iNa_h_k1)).*(((L5_v(n-1,:) + .5*dt*L5_v_k1))-p.L5_iNa_ENa))))+((((-p.L5_iK_gK.*((L5_iK_n(n-1,:) + .5*dt*L5_iK_n_k1)).^4.*(((L5_v(n-1,:) + .5*dt*L5_v_k1))-p.L5_iK_EK))))))+p.L5_noise*randn(1,p.L5_Npop);
  ...
  L2_L3_iGABA_s_k2 = -((L2_L3_iGABA_s(n-1,:) + .5*dt*L2_L3_iGABA_s_k1))./p.L2_L3_iGABA_tauGABA + ((1-((L2_L3_iGABA_s(n-1,:) + .5*dt*L2_L3_iGABA_s_k1)))/p.L2_L3_iGABA_tauGABAr).*(1+tanh(((L3_v(n-1,:) + .5*dt*L3_v_k1))/10));
  ...
  L1_v_k3 =p.L1_Iapp+((((-p.L1_iNa_gNa.*((L1_iNa_m(n-1,:) + .5*dt*L1_iNa_m_k2)).^3.*((L1_iNa_h(n-1,:) + .5*dt*L1_iNa_h_k2)).*(((L1_v(n-1,:) + .5*dt*L1_v_k2))-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*((L1_iK_n(n-1,:) + .5*dt*L1_iK_n_k2)).^4.*(((L1_v(n-1,:) + .5*dt*L1_v_k2))-p.L1_iK_EK))))+((-(((p.L1_L4_iGABA_gGABA.*(((L1_L4_iGABA_s(n-1,:) + .5*dt*L1_L4_iGABA_s_k2))*L1_L4_iGABA_netcon).*(((L1_v(n-1,:) + .5*dt*L1_v_k2))-p.L1_L4_iGABA_EGABA))))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  L4_v_k3 =p.L4_Iapp+((((-p.L4_iNa_gNa.*((L4_iNa_m(n-1,:) + .5*dt*L4_iNa_m_k2)).^3.*((L4_iNa_h(n-1,:) + .5*dt*L4_iNa_h_k2)).*(((L4_v(n-1,:) + .5*dt*L4_v_k2))-p.L4_iNa_ENa))))+((((-p.L4_iK_gK.*((L4_iK_n(n-1,:) + .5*dt*L4_iK_n_k2)).^4.*(((L4_v(n-1,:) + .5*dt*L4_v_k2))-p.L4_iK_EK))))))+p.L4_noise*randn(1,p.L4_Npop);
  ...
  L5_v_k3 =p.L5_Iapp+((((-p.L5_iNa_gNa.*((L5_iNa_m(n-1,:) + .5*dt*L5_iNa_m_k2)).^3.*((L5_iNa_h(n-1,:) + .5*dt*L5_iNa_h_k2)).*(((L5_v(n-1,:) + .5*dt*L5_v_k2))-p.L5_iNa_ENa))))+((((-p.L5_iK_gK.*((L5_iK_n(n-1,:) + .5*dt*L5_iK_n_k2)).^4.*(((L5_v(n-1,:) + .5*dt*L5_v_k2))-p.L5_iK_EK))))))+p.L5_noise*randn(1,p.L5_Npop);
  ...
  L2_L3_iGABA_s_k3 = -((L2_L3_iGABA_s(n-1,:) + .5*dt*L2_L3_iGABA_s_k2))./p.L2_L3_iGABA_tauGABA + ((1-((L2_L3_iGABA_s(n-1,:) + .5*dt*L2_L3_iGABA_s_k2)))/p.L2_L3_iGABA_tauGABAr).*(1+tanh(((L3_v(n-1,:) + .5*dt*L3_v_k2))/10));
  ...
  t = t + .5*dt;
  L1_v_k4 =p.L1_Iapp+((((-p.L1_iNa_gNa.*((L1_iNa_m(n-1,:) + dt*L1_iNa_m_k3)).^3.*((L1_iNa_h(n-1,:) + dt*L1_iNa_h_k3)).*(((L1_v(n-1,:) + dt*L1_v_k3))-p.L1_iNa_ENa))))+((((-p.L1_iK_gK.*((L1_iK_n(n-1,:) + dt*L1_iK_n_k3)).^4.*(((L1_v(n-1,:) + dt*L1_v_k3))-p.L1_iK_EK))))+((-(((p.L1_L4_iGABA_gGABA.*(((L1_L4_iGABA_s(n-1,:) + dt*L1_L4_iGABA_s_k3))*L1_L4_iGABA_netcon).*(((L1_v(n-1,:) + dt*L1_v_k3))-p.L1_L4_iGABA_EGABA))))))))+p.L1_noise*randn(1,p.L1_Npop);
  ...
  L4_v_k4 =p.L4_Iapp+((((-p.L4_iNa_gNa.*((L4_iNa_m(n-1,:) + dt*L4_iNa_m_k3)).^3.*((L4_iNa_h(n-1,:) + dt*L4_iNa_h_k3)).*(((L4_v(n-1,:) + dt*L4_v_k3))-p.L4_iNa_ENa))))+((((-p.L4_iK_gK.*((L4_iK_n(n-1,:) + dt*L4_iK_n_k3)).^4.*(((L4_v(n-1,:) + dt*L4_v_k3))-p.L4_iK_EK))))))+p.L4_noise*randn(1,p.L4_Npop);
  ...
  L5_v_k4 =p.L5_Iapp+((((-p.L5_iNa_gNa.*((L5_iNa_m(n-1,:) + dt*L5_iNa_m_k3)).^3.*((L5_iNa_h(n-1,:) + dt*L5_iNa_h_k3)).*(((L5_v(n-1,:) + dt*L5_v_k3))-p.L5_iNa_ENa))))+((((-p.L5_iK_gK.*((L5_iK_n(n-1,:) + dt*L5_iK_n_k3)).^4.*(((L5_v(n-1,:) + dt*L5_v_k3))-p.L5_iK_EK))))))+p.L5_noise*randn(1,p.L5_Npop);
  ...
  L2_L3_iGABA_s_k4 = -((L2_L3_iGABA_s(n-1,:) + dt*L2_L3_iGABA_s_k3))./p.L2_L3_iGABA_tauGABA + ((1-((L2_L3_iGABA_s(n-1,:) + dt*L2_L3_iGABA_s_k3)))/p.L2_L3_iGABA_tauGABAr).*(1+tanh(((L3_v(n-1,:) + dt*L3_v_k3))/10));
  ...
  L2_L3_iGABA_s(n,:) = L2_L3_iGABA_s(n-1,:)+(dt/6)*(L2_L3_iGABA_s_k1 + 2*(L2_L3_iGABA_s_k2 + L2_L3_iGABA_s_k3) + L2_L3_iGABA_s_k4);
